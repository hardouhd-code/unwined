...
/* ═══════════════════════════════════════════════════════════════
   SUPABASE — Auth + Sync
═══════════════════════════════════════════════════════════════ */
const SUPA_URL = "https://xvjhodhgiiygrnmggvaz.supabase.co";
const SUPA_KEY = "sb_publishable_agi3sVWygsRiUkBX8GmjGw_fmHUix6k";
...
const supa = {
  ...
  async getSession() {
    ...
    } catch { localStorage.removeItem("unwined_session"); supa._token=null; supa._user=null; }
    return null;
  },
  saveSession(data) {
  ...
  async saveProfile(userId, name, cave) {
    const body = JSON.stringify({user_id:userId, name, cave:JSON.stringify(cave), updated_at:new Date().toISOString()});
    try {
      await supa.req(`/rest/v1/profiles?user_id=eq.${userId}`, {method:"PATCH", body, headers:{"Prefer":"resolution=merge-duplicates"}});
    } catch {
      await supa.req("/rest/v1/profiles", {method:"POST", body, headers:{"Prefer":"return=minimal"}});
    }
  },
};

/* ═══════════════════════════════════════════════════════════════
   I18N — Français / Nederlands
═══════════════════════════════════════════════════════════════ */
const LANG = (()=>{
...
const T = {
  fr: {
    personal_sommelier:t("personal_sommelier"),
    tagline:t("tagline"),
    login:t("login"), signup:t("signup"),
    google:t("google"),
    email:t("email"), password:t("password"),
    sign_in:t("sign_in"), create_account:t("create_account"),
    check_email:"Vérifiez votre email pour confirmer.",
    connected:t("connected"), syncing:t("syncing"), logout:t("logout"),
    nav_home:"Accueil", nav_cave:"Ma Cave", nav_scan:"Scanner", nav_discover:"Découvrir",
    welcome:t("welcome"), name_q:t("name_q"),
    name_placeholder:t("name_placeholder"), enter:t("enter"), change:t("change"),
    good_morning:t("good_morning"), good_afternoon:t("good_afternoon"), good_evening:t("good_evening"),
    proposes:t("proposes"),
    three_ranges:t("three_ranges"),
    refresh:t("refresh"), thinking:t("thinking"),
    personalized:t("personalized"),
    see_selection:t("see_selection"),
    based_on:(n)=>`Basé sur vos ${n} dégustation${n>1?"s":""}, voici ma sélection du jour.`,
    no_prefs:t("no_prefs"),
    cave_empty:t("cave_empty"),
    cave_empty_sub:"Commencez par ajouter un vin\npour constituer votre collection.",
    add_first:t("add_first"),
    search:t("search"),
    filter_all:t("filter_all"), filter_cave:t("filter_cave"), filter_tasted:t("filter_tasted"), filter_top:t("filter_top"), filter_avoid:t("filter_avoid"),
    your_rating:t("your_rating"), modify_rating:t("modify_rating"), rate_wine:t("rate_wine"),
    bottles_in_cave:t("bottles_in_cave"), bottle:"bouteille", bottles:"bouteilles",
    delete:t("delete"), confirm_delete:t("confirm_delete"),
    online_sheet:t("online_sheet"), online_sheet_sub:t("online_sheet_sub"),
    terroir:t("terroir"),
    step:"Étape", of:"/",
    ...
    vintage:t("vintage"), producer:t("producer"),
    producer_ph:"Ex: Château Margaux, Domaine Leroy…",
    wine_name:t("wine_name"), optional:t("optional"),
    wine_name_ph:"Ex: Cuvée Prestige, Grand Cru…",
    bottles_label:t("bottles_in_cave"), bottles_zero:t("bottles_zero"),
    tasted_q:"L'avez-vous\ndéjà goûté ?", tasted_sub:"Votre mémoire gustative est précieuse.",
    yes_tasted:"Oui, je l'ai bu", not_yet:"Non, pas encore",
    your_notes:"Vos notes personnelles", notes_ph:"Arômes, accords, souvenirs…",
    continue:t("continue"), save:t("save"),
    scanner_title:t("scanner_title"),
    scanner_sub:"Scannez une étiquette de bouteille\nou une carte des vins au restaurant.",
    take_photo:t("take_photo"), open_camera:t("open_camera"),
    from_gallery:t("from_gallery"),
    analyzing:t("analyzing"), analyzing_sub:t("analyzing_sub"),
    add_to_cave:t("add_to_cave"), scan_another:t("scan_another"),
    online_info:t("online_sheet"), not_referenced:t("not_referenced"),
    discover_title:"Découvrir", suggestions_tab:t("suggestions_tab"), search_tab:"Recherche",
    generate:"Générer ma sélection", via_claude:t("via_claude"),
    retry:t("retry"), search_btn:t("search_btn"),
  },
  nl: {
    ...
    sign_in:"Inloggen", create_account:"Account aanmaken",
    check_email:"Controleer uw e-mail om uw account te bevestigen.",
    connected:"✓ verbonden", syncing:t("syncing"), logout:"Uitloggen",
    nav_home:"Startpagina", nav_cave:"Mijn Kelder", nav_scan:"Scanner", nav_discover:"Ontdekken",
    welcome:"Welkom", name_q:"Hoe mag ik u noemen?",
    name_placeholder:"Uw voornaam…", enter:"Verder →", change:"Wijzigen",
    ...
    refresh:"↺ Andere", thinking:"De sommelier denkt na…",
    ...
    cave_empty:"Uw kelder is leeg",
    cave_empty_sub:"Begin met het toevoegen van een wijn\nom uw collectie op te bouwen.",
    add_first:"+ Mijn eerste wijn toevoegen",
    search:"Zoeken…",
    filter_all:"Alle", filter_cave:"In kelder", filter_tasted:"Geproefd", filter_top:t("filter_top"), filter_avoid:"Vermijden",
    your_rating:"Uw beoordeling", modify_rating:"Beoordeling wijzigen", rate_wine:"Beoordeel deze wijn",
    bottles_in_cave:"Flessen in kelder", bottle:"fles", bottles:"flessen",
    delete:"🗑 Verwijderen uit mijn kelder", confirm_delete:"Deze wijn verwijderen?",
    online_sheet:"Online fiche", online_sheet_sub:"Prijs, spijscombinatie, hoogtepunt, criticus…",
    ...
    vintage:"Oogstjaar", producer:"Huis / Domein / Château",
    producer_ph:"Bijv: Château Margaux, Domaine Leroy…",
    wine_name:"Naam van de wijn", optional:"optioneel",
    wine_name_ph:"Bijv: Cuvée Prestige, Grand Cru…",
    bottles_label:"Flessen in kelder", bottles_zero:"0 = al gedronken / niet meer op voorraad",
    tasted_q:"Heeft u hem al\ngeproefd?", tasted_sub:"Uw smaakgeheugen is kostbaar.",
    yes_tasted:"Ja, ik heb hem gedronken", not_yet:"Nee, nog niet",
    your_notes:"Uw persoonlijke notities", notes_ph:"Aroma's, combinaties, herinneringen…",
    continue:"Doorgaan →", save:"Deze wijn opslaan",
    scanner_title:"Slimme Scanner",
    scanner_sub:"Scan een flessenlabel\nof een wijnkaart in het restaurant.",
    take_photo:"Een foto nemen", open_camera:"Opent de camera",
    from_gallery:"Kiezen uit galerij",
    analyzing:"Analyse bezig…", analyzing_sub:"De sommelier bekijkt uw afbeelding",
    add_to_cave:"+ Toevoegen aan mijn kelder", scan_another:"↺ Nog een scannen",
    online_info:"Online fiche", not_referenced:"Niet vermeld in de grote gidsen",
    discover_title:"Ontdekken", suggestions_tab:"Suggesties", search_tab:"Zoeken",
    generate:"Mijn selectie genereren", via_claude:t("via_claude"),
    retry:"Opnieuw proberen", search_btn:"Zoeken",
  }
};
const t = (key, ...args) => {
        ...
        {step===4&&(
          <div style={{animation:"fadeUp .4s ease"}}>
            ...
            <div style={{marginBottom:16}}>
              <label style={lbl}>Bouteilles en cave</label>
      ...
      <div style={{background:`linear-gradient(160deg,${tl} 0%,transparent 40%)`,minHeight:"100vh"}}>
        ...
        <div style={{padding:"0 20px 80px"}}>
          ...
          <div style={{background:C.bgCard,border:"1px solid rgba(139,90,60,.12)",borderRadius:18,padding:"16px 20px",marginBottom:14,display:"flex",alignItems:"center",justifyContent:"space-between",gap:16}}>
            <div>
              <div style={{fontSize:11,color:C.muted,letterSpacing:".2em",textTransform:"uppercase",fontFamily:"Cormorant Garamond,serif",marginBottom:8}}>Bouteilles en cave</div>
              <div style={{display:"flex",alignItems:"center",gap:12}}>
...
export default function UnwinedApp() {
  ...
  const loadUserData=async(userId)=>{
    ...
    if(profile){
      // Supabase est la source de vérité — toujours prioritaire
      if(profile.name) setUserName(profile.name);
      if(profile.cave !== undefined && profile.cave !== null) {
        try{ setDb(JSON.parse(profile.cave)); }catch{}
      }
      // Effacer le localStorage pour éviter les conflits
      localStorage.removeItem("unwined_v4_db");
    } else {
      // Pas encore de profil en ligne → migrer depuis localStorage
      const localName=localStorage.getItem("unwined_v4_name")||"";
      if(localName) setUserName(localName);
      try{ const local=JSON.parse(localStorage.getItem("unwined_v4_db")||"[]"); if(local.length) setDb(local); }catch{}
    }
  };
  ...
  useEffect(()=>{
    ...
    const t=setTimeout(async()=>{
      setSyncing(true);
      try{ await supa.saveProfile(user.id, userName, db); }catch{}
      setSyncing(false);
    }, 1500);
  ...
  const deleteWine=(id)=>{setDb(d=>d.filter(w=>w.id!==id));setScreen("cave");setTab("cave");};
        ...
        <div style={{padding:"20px 16px 0",flexShrink:0}}>
          <div style={{textAlign:"center",marginBottom:16}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6,padding:"0 4px"}}>
              ...
              <button onClick={handleSignOut} style={{fontSize:11,color:C.muted,background:"none",border:"1px solid rgba(139,90,60,.2)",borderRadius:10,padding:"3px 10px",fontFamily:"Cormorant Garamond,serif"}}>Déconnexion</button>
            </div>
