...
const GLOBAL_CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent;}
  ...
  html,body{background:#19120d;color:#efe0d6;overscroll-behavior:none;-webkit-overflow-scrolling:touch;font-family:'Manrope',sans-serif;font-size:16px;line-height:1.45;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-rendering:optimizeLegibility;}
  button{border:none;background:none;cursor:pointer;touch-action:manipulation;}
  button:focus,input:focus,select:focus,textarea:focus{outline:none;}
  a{color:inherit;text-decoration:none;}
  p,h1,h2,h3,div,span{line-height:inherit;}
  h1,h2,h3{line-height:1.15;}
  ::-webkit-scrollbar{width:0;}
  input::placeholder,textarea::placeholder{color:rgba(212,195,184,0.45);}
  select option{background:#19120d;color:#efe0d6;}
  input,textarea,select{font-family:'Manrope',sans-serif;font-size:16px;}
  button{min-height:42px;}
  .app-shell{width:100%;max-width:460px;margin:0 auto;min-height:100vh;background:#19120d;position:relative;padding-bottom:env(safe-area-inset-bottom);}
  .android-glass{background:rgba(25,18,13,.72);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid rgba(197,160,89,.16);}
