...
const MaCave=({db,onOpenWine,onAdd})=>{
  ...
  if(db.length===0)return(
    <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",paddingTop:"80px",paddingBottom:"100px",paddingLeft:"24px",paddingRight:"24px",textAlign:"center"}}>
