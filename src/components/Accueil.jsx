  ...
  <div style={{
    ...
    {[100, 70, 90, 50].map((w, i) => (
      <div key={i} style={{
        ...
        borderRadius: 8,
        marginBottom: 12,
        background: "linear-gradient(90deg, #2f251f 25%, #3a2e27 50%, #2f251f 75%)",
...
[{"type":"rouge","region":"Bordeaux","country":"France","grapes":"Merlot","description":"...","why":"..."},...]`;
  ...
  /* ── VUE PRINCIPALE ── */
  return (
    <div style={{ flex: 1, overflowY: "auto", padding: "20px 16px 104px" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <h2 style={{ fontSize: 32, fontFamily: "Playfair Display,serif", color: C.cream, fontWeight: 500, margin: 0, lineHeight: 1.1 }}>
              {userName}
      ...
      {favoriteCount > 0 && (
        <div style={{ marginBottom: 18, background: "rgba(233,193,118,.1)", border: "1px solid rgba(233,193,118,.25)", borderRadius: 14, padding: "12px 14px" }}>
      ...
      {(analytics.tastedCount > 0 || analytics.repurchase > 0) && (
        <div style={{ marginBottom: 18, background: "rgba(48,40,34,.75)", border: "1px solid rgba(197,160,89,.24)", borderRadius: 14, padding: "12px 14px" }}>
          <div style={{ fontSize: 10, color: C.gold, letterSpacing: ".16em", textTransform: "uppercase", fontWeight: 700 }}>
            Analytics rapides
          </div>
          <div style={{ fontSize: 13, color: C.subtext, marginTop: 4 }}>
        ...
        return (
          <div
            ...
            style={{
              ...
              opacity: 0,
              boxShadow: "0 18px 36px rgba(0,0,0,.35), 0 2px 10px rgba(0,0,0,.25)",
            ...
            <div style={{ display: "flex", gap: 10, marginBottom: 10 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 16, fontFamily: "Playfair Display,serif", color: C.cream, fontWeight: 500, lineHeight: 1.2, marginBottom: 2, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
                  {wine.name}
                </div>
                <div style={{ fontSize: 12, color: C.muted, fontFamily: "Cormorant Garamond,serif", fontStyle: "italic", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                  {wine.producer}
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 10 }}>
              {[WINE_TYPES.find(t => t.id === wine.type)?.label, wine.region, wine.country, wine.year]
                .filter(Boolean).slice(0, 3).map(tag => <Tag key={String(tag)} color={C.gold}>{tag}</Tag>)}
            </div>
            ...
            <a
              ...
              style={{
                ...
                background: `linear-gradient(135deg, rgba(184,134,42,.22), rgba(184,134,42,.12))`,
                border: `1px solid rgba(184,134,42,.45)`,
