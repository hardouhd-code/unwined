    ...
    try{
      const body={
        ...
        messages:[{role:"user",content:[
          ...
          {type:"text",text:`Expert en vins. Lis cette étiquette et réponds UNIQUEMENT en JSON valide, rien d'autre :
...
Si tu ne peux pas lire l'étiquette, réponds: {"error":"illisible"}`}
        ]}]
      };
      ...
      console.log("API status:", r.status, rawText.slice(0,200));
