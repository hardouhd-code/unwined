...
const SmartScanner=({profile,onResult,onBack})=>{
  ...
  const scan=async(imageBase64)=>{
    setPhase("scanning");
    try{
      // Appel Gemini Flash pour la vision
      ...
      console.log("Gemini status:", r.status, rawText.slice(0,200));

      if(r.status===429) throw new Error("Quota Gemini dépassé — attends 1 minute et réessaie");
