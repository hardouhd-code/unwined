...
{"name":"Vin imaginaire","domaine":"Domaine","grape":"Cépage","region":"Région, Pays","year":2020,"vivinoRating":4.1,"priceEst":"35 €","aeration":30,"pH":3.85,"tannins":8,"glycerol":8,"malo":true,"story":"Histoire poétique","anecdote":"Fait surprenant","emoji":"🍷","vibe":"cocon"}`}];
      ...
      const msg=e?.message||"";
      if(msg.includes("ANTHROPIC_API_KEY")||msg.includes("401")||msg.includes("auth")){
        setErrMsg("Clé API invalide. Vérifie ANTHROPIC_API_KEY dans Vercel.");
      } else if(msg.includes("fetch")||msg.includes("network")||msg.includes("Failed to fetch")){
        setErrMsg("Connexion impossible. Vérifie ta connexion internet.");
      } else if(msg.includes("parse")||msg.includes("JSON")||msg.includes("Unexpected")){
        setErrMsg("Réponse illisible. Rapproche l'étiquette et réessaie.");
      } else if(msg.includes("413")||msg.includes("large")){
        setErrMsg("Image trop grande. Réessaie.");
      } else {
        setErrMsg(`Erreur: ${msg||"inconnue"}`);
      }
      setPhase("error");
      return;
    }
