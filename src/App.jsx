        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
          ...
          {tab==="cave"&&(
            <>
              ...
              {/* Bouton + flottant dans Ma Cave */}
              <button onClick={()=>setScreen("add")} style={{position:"fixed",bottom:90,right:"calc(50% - 200px)",width:52,height:52,borderRadius:"50%",background:`linear-gradient(135deg,${C.terra},${C.terraD})`,border:"none",color:"#fff",fontSize:26,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:`0 6px 20px rgba(200,80,58,.4)`,zIndex:99,fontWeight:300,lineHeight:1}}>＋</button>
            </>
          )}
