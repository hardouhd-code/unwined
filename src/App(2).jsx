...
const WineInfoCard=({wine})=>{
  ...
  return(
    <div style={{background:"rgba(184,134,42,.07)",border:`1px solid rgba(184,134,42,.22)`,borderRadius:16,padding:"16px",marginBottom:14,animation:"fadeIn .4s ease"}}>
      ...
      <a href={`https://www.wine-searcher.com/find/${encodeURIComponent((info.search_query||q).replace(/\s+/g,"+"))}`} target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:6,background:`rgba(200,80,58,.12)`,border:`1px solid rgba(200,80,58,.3)`,borderRadius:20,padding:"7px 16px",textDecoration:"none",color:C.terra,fontSize:10,letterSpacing:".12em",textTransform:"uppercase",fontFamily:"Cormorant Garamond,serif"}}>🔍 Voir sur Vivino</a>
    </div>
  );
};
            ...
            <>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end",marginBottom:16}}>
                <div>
                  ...
                  <p style={{fontSize:12,color:C.subtext,fontFamily:"Cormorant Garamond,serif",fontStyle:"italic"}}>Via Claude · {vivinoWines.length} vins</p>
                </div>
      ...
      {mode==="search"&&(
        <>
          <div style={{marginBottom:16}}>
            ...
            <p style={{fontSize:12,color:C.subtext,fontFamily:"Cormorant Garamond,serif",fontStyle:"italic"}}>Décrivez ce que vous cherchez.</p>
          </div>
          ...
          {searchPhase==="done"&&searchResults&&(
            <>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
                <div style={{fontSize:11,color:C.subtext,fontFamily:"Cormorant Garamond,serif"}}>{searchResults.length} résultat{searchResults.length>1?"s":""}</div>
...
[{"name":"Château X","producer":"Domaine Y","type":"rouge","region":"Bordeaux","country":"France","year":2020,"price_range":"18-24€","grapes":"Merlot, Cabernet","description":"2 phrases arômes et style","why":"Raison personnalisée","search_query":"Chateau X 2020","budget":"budget"},{"name":"...","producer":"...","type":"blanc","region":"...","country":"...","year":2021,"price_range":"45-55€","grapes":"...","description":"...","why":"...","search_query":"...","budget":"milieu"},{"name":"...","producer":"...","type":"rouge","region":"...","country":"...","year":2019,"price_range":"90-120€","grapes":"...","description":"...","why":"...","search_query":"...","budget":"prestige"}]`;
  ...
  if(editingName) return(
    <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 28px",textAlign:"center"}}>
      ...
      />
      <button onClick={saveName} disabled={!nameInput.trim()} style={{background:`linear-gradient(135deg,${C.terra},${C.terraD})`,color:"#fff",border:"none",padding:"14px 36px",borderRadius:50,fontSize:12,letterSpacing:".2em",textTransform:"uppercase",fontFamily:"Cormorant Garamond,serif",fontWeight:700,opacity:nameInput.trim()?1:.4}}>
        Entrer →
      </button>
    </div>
  );
  ...
  return(
    <div style={{flex:1,overflowY:"auto",padding:"20px 16px 100px"}}>
      ...
      <div style={{marginBottom:24}}>
        <div style={{fontSize:13,color:C.muted,fontFamily:"Cormorant Garamond,serif",fontStyle:"italic",marginBottom:4}}>{greeting},</div>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          ...
          <button onClick={()=>{setEditingName(true);setNameInput(userName);}} style={{fontSize:11,color:C.muted,background:"none",fontFamily:"Cormorant Garamond,serif",textDecoration:"underline"}}>Changer</button>
        </div>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
        <div>
          ...
          <div style={{fontSize:11,color:C.muted,fontFamily:"Cormorant Garamond,serif",marginTop:2}}>Une sélection sur 3 gammes de prix</div>
        </div>
        {phase==="done"&&(
          <button onClick={loadWines} style={{display:"flex",alignItems:"center",gap:5,background:"rgba(184,134,42,.1)",border:`1px solid rgba(184,134,42,.3)`,borderRadius:20,padding:"7px 13px",color:C.gold,fontSize:11,fontFamily:"Cormorant Garamond,serif"}}>
      ...
      {phase==="loading"&&(
        <div style={{textAlign:"center",padding:"50px 20px"}}>
          ...
          <div style={{fontSize:12,color:C.muted,fontFamily:"Cormorant Garamond,serif",fontStyle:"italic"}}>Sélection personnalisée en cours</div>
        </div>
      )}
      ...
      {phase==="error"&&(
        <div style={{textAlign:"center",padding:"30px 16px"}}>
          <div style={{fontSize:13,color:C.terra,fontFamily:"Cormorant Garamond,serif",marginBottom:14}}>{error}</div>
          <button onClick={loadWines} style={{background:`rgba(200,80,58,.1)`,border:`1px solid rgba(200,80,58,.3)`,borderRadius:20,padding:"10px 24px",color:C.terra,fontSize:13,fontFamily:"Playfair Display,serif"}}>Réessayer</button>
        </div>
      )}
      ...
      {phase==="idle"&&(
        <div style={{textAlign:"center",padding:"40px 16px"}}>
          <button onClick={loadWines} style={{background:`linear-gradient(135deg,${C.terra},${C.terraD})`,color:"#fff",border:"none",padding:"16px 36px",borderRadius:50,fontSize:12,letterSpacing:".2em",textTransform:"uppercase",fontFamily:"Cormorant Garamond,serif",fontWeight:700,boxShadow:`0 8px 24px rgba(200,80,58,.25)`}}>
            Voir ma sélection →
          </button>
        </div>
      )}
      ...
      {phase==="done"&&wines&&wines.map((wine,i)=>{
        ...
        return(
          <div key={i} style={{background:C.bgCard,border:`1px solid ${tc}22`,borderRadius:20,padding:"18px",marginBottom:14,animation:`fadeUp .4s ease ${i*.12}s both`,opacity:0,boxShadow:`0 4px 16px rgba(139,90,60,.07)`}}>
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
              <div style={{display:"flex",alignItems:"center",gap:8}}>
                ...
                <div>
                  ...
                  <div style={{fontSize:11,color:C.subtext,fontFamily:"Cormorant Garamond,serif"}}>{wine.producer}</div>
                </div>
              </div>
              <div style={{textAlign:"right",flexShrink:0,marginLeft:8}}>
                <div style={{fontSize:13,fontFamily:"Playfair Display,serif",color:budgetColor,fontWeight:700}}>{wine.price_range}</div>
                <div style={{fontSize:9,color:budgetColor,background:`${budgetColor}15`,border:`1px solid ${budgetColor}33`,borderRadius:10,padding:"2px 7px",fontFamily:"Cormorant Garamond,serif",letterSpacing:".06em",marginTop:2}}>{budgetLabel}</div>
              </div>
            </div>
            ...
            {/* Why + description */}
            {wine.why&&<p style={{fontSize:13,color:C.terra,fontFamily:"Cormorant Garamond,serif",fontStyle:"italic",lineHeight:1.7,marginBottom:6,fontWeight:600}}>{wine.why}</p>}
            {wine.description&&<p style={{fontSize:12,color:C.subtext,fontFamily:"Cormorant Garamond,serif",lineHeight:1.7,marginBottom:12}}>{wine.description}</p>}
      ...
      {phase==="done"&&db.length===0&&(
        <div style={{background:`rgba(184,134,42,.06)`,border:`1px solid rgba(184,134,42,.2)`,borderRadius:16,padding:"16px",marginTop:8,textAlign:"center"}}>
          <p style={{fontSize:12,color:C.subtext,fontFamily:"Cormorant Garamond,serif",fontStyle:"italic",lineHeight:1.7,marginBottom:12}}>Notez vos vins pour affiner la sélection selon vos goûts réels.</p>
          <button onClick={onAdd} style={{background:`linear-gradient(135deg,${C.terra},${C.terraD})`,color:"#fff",border:"none",padding:"11px 24px",borderRadius:30,fontSize:11,letterSpacing:".15em",textTransform:"uppercase",fontFamily:"Cormorant Garamond,serif",fontWeight:600}}>+ Ajouter un vin</button>
        </div>
      )}
    </div>
  );
...
export default function UnwinedApp() {
  ...
  const TABS=[{id:"accueil",label:"Accueil",icon:"🏠"},{id:"cave",label:"Ma Cave",icon:"🗄️"},{id:"add",label:"Ajouter",icon:"＋"},{id:"scan",label:"Scanner",icon:"📷"},{id:"decouvrir",label:"Découvrir",icon:"✦"}];
